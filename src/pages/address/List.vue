    ...
    <div>
       ...
       <!-- ！！！:（冒号） 绑定数据 -->
        <el-table :data="address">
            ...
            <el-table-column prop ="area" label="市"></el-table-column>
            <el-table-column width="120" prop ="address" label="路"></el-table-column>
            <el-table-column width="200" prop ="telephone" label="电话"></el-table-column>
            <el-table-column width="200" prop ="customerId" label="id"></el-table-column>
            <!-- fixed 固定定位 -->
